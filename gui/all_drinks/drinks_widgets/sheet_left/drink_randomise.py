...
class DrinkRandomise(QPushButton):
    def __init__(self, path, randomise_callback=None):
        super().__init__()
        self._path = path
        self._image_label = QLabel(self)
        self._callback = randomise_callback
    ...
    def _initialize_image_label(self):
        ...
        pixmap = QPixmap(Utility.get_image_path("randomise.png", self._path))
