...
from core.config import AllDrinksConfig
from gui.all_drinks.drinks_widgets import GotoHomeButton, SheetLeft, SheetRight


class AllDrinksPage(QWidget):
    def __init__(self, configuration: AllDrinksConfig, goto_home_callback):
        super().__init__()

        self._config = configuration
        self._goto_home_button = GotoHomeButton(goto_home_callback)
        self._sheet_left = SheetLeft(configuration.sheet_left)
